...
export default function CarCard(props: CarCardProps) {
    ...
    return (
        <a href="https://www.google.com" id={styles.card} className=" p-1 border border-black rounded-lg drop-shadow w-64 h-64 flex flex-col content-between justify-start items-center">
